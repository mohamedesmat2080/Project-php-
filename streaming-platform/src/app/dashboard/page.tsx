...
import { Play, History, List, User, ChevronLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-24 px-4">
        <div className="container mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="group cursor-pointer">
                  ...
                  <h3 className="font-medium truncate">فيلم {item}</h3>
                  <p className="text-sm text-gray-400">45 دقيقة متبقية</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">الأكثر شعبية على ستريم إكس</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
